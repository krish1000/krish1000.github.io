// document.addEventListener('DOMContentLoaded',function(event){
    ...
    var dataText = [ "Programmer.", "Gamer.", "Computer Science Undergraduate Student.", "Web Designer.", "Made this site using React JSX", "Software Developer."];
    ...
    function typeWriter(text, i, fnCallback) {
      ...
      if (i < (text.length)) {
        ...
        document.getElementById("welcome-type-writer").innerHTML = text.substring(0, i+1) +'<span class="type-writer" aria-hidden="true"></span>';
