        ...
        <div id="welcome" className='section-welcome-jumbo'>
            ...
            <Col className='align-flex-style'>
                ...
                {/* <Col style={{alignItems: 'center', textAlign: 'center', justifyContent: 'center'}}> */}
                    ...
                    <h1 style={{fontSize: 15, fontFamily: "Courier New", fontWeight: 500, fontSize: 'calc(7px + 0.90vw)', paddingTop: '5px'}}> <span style={{color: "#5EFC8D", fontWeight: 900}}> {'>'} </span> <span id="welcome-type-writer"></span> </h1> {/* caret animation in type.js applied via class on span */}
                    </Row>
                    </div>
                    <Row className='align-flex-style' style={{marginBottom: 'calc(55px + 6.85vh)'}}>
                        <Button href='#about' className='button-more-about'>MORE ABOUT ME <FaAngleDown /> </Button>
                    </Row>
                    {icons()}
